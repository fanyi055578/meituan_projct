...
class Address(models.Model):
    realname = models.CharField(max_length=100, verbose_name='真是姓名',null=True)
    telephone = models.CharField(max_length=11, verbose_name='手机号码')
    province = models.CharField(max_length=100, verbose_name='省份')
    city = models.CharField(max_length=100, verbose_name='城市',null=True)
    county = models.CharField(max_length=100, verbose_name='区县',null=True)
    detail_road = models.CharField(max_length=100, verbose_name='详细地址')
    ...
    user = models.ForeignKey(MTUser, related_name='address', on_delete=models.CASCADE)
